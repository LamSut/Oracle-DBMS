...
delete from customer where idacc = '9907543817';
...
-- call signup('11111111111', 'Suttocdo_007', '000000000001', '0907543818','666666');
...
-- call intransfer('11111111111','9907543817',10000);
select * from customer;
...
drop role 'admin','manager','developer','user';
create role 'admin','manager','developer','user';

grant all privileges on moomoobank.* to 'admin';

grant select on moomoobank.* to 'manager';
grant all privileges on moomoobank.account to 'manager';
grant all privileges on moomoobank.customer to 'manager';

grant all privileges on moomoobank.account to 'developer';
grant all privileges on moomoobank.customer to 'developer';

grant select on moomoobank.account to 'user'; 
grant select on moomoobank.customer to 'user'; 